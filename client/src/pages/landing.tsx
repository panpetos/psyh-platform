          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl lg:text-6xl font-bold text-text-custom mb-6">
                Найдите своего <span className="text-primary-custom">ИИ психолога</span> онлайн
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/search">
                  <Button
                    className="w-full sm:w-auto bg-gradient-to-r from-primary-custom via-secondary-custom to-accent-custom text-white px-10 py-4 rounded-2xl font-semibold shadow-lg transition text-lg hover:from-primary-custom/90 hover:via-secondary-custom/90 hover:to-accent-custom/90"
